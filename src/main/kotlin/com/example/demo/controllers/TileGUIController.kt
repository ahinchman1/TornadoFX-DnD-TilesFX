...
class TileGUIController : Controller() {
    ...
    private val tilePane3 = listOf(
            ...
            TilePlacement(gridTileBuilder("2"), 1, 0, 1, 1),
            TilePlacement(gridTileBuilder("3"), 2, 0, 1, 1),
            TilePlacement(gridTileBuilder("1", 310.0), 3, 0, 3, 1),
            TilePlacement(gridTileBuilder("2"), 0, 1, 1, 1),
            TilePlacement(gridTileBuilder("3"), 0 , 2, 1, 1),
            TilePlacement(gridTileBuilder("4"), 0, 3, 1, 1),
            TilePlacement(gridTileBuilder("5", 210.0, 210.0), 1, 1, 2, 2),
            TilePlacement(gridTileBuilder("6"), 1, 3, 1 ,1),
            TilePlacement(gridTileBuilder("7"), 2, 3, 1, 1),
            TilePlacement(gridTileBuilder("8", 210.0, 210.0), 3, 1, 2, 2),
            TilePlacement(gridTileBuilder("9"), 3, 3, 1, 1),
            TilePlacement(gridTileBuilder("10"), 4, 3, 1, 1),
            TilePlacement(gridTileBuilder("11"), 5, 1, 1, 1),
            TilePlacement(gridTileBuilder("12"), 5, 2, 1, 1),
    ...
    private val tilePane4 = listOf(
            ...
            TilePlacement(gridTileBuilder("3"), 2, 0, 1, 1),
            TilePlacement(gridTileBuilder("1", 310.0), 3, 0, 3, 1),
            TilePlacement(gridTileBuilder("2", 210.0, 210.0), 0, 1, 2, 2),
            TilePlacement(gridTileBuilder("3"), 0 , 3, 1, 1),
            TilePlacement(gridTileBuilder("4"), 1, 3, 1, 1),
            TilePlacement(gridTileBuilder("5", 210.0, 210.0), 2, 1, 2, 2),
            TilePlacement(gridTileBuilder("6"), 2, 3, 1 ,1),
            TilePlacement(gridTileBuilder("7"), 3, 3, 1, 1),
            TilePlacement(gridTileBuilder("8", 210.0, 210.0), 4, 1, 2, 2),
            TilePlacement(gridTileBuilder("9"), 4, 3, 1, 1),
            TilePlacement(gridTileBuilder("10"), 5, 3, 1, 1)
    ).observable()
