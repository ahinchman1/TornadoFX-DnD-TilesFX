...
class MetroTileHomepage20 : View() {
    private val loginController: LoginController by inject()
    private val workbenchController: WorkbenchController by inject()

    override val root: BorderPane by fxml("/fxml/MetroTileHomepage20.fxml")
                ...
                vbox {
                    ...
                    hbox {
                        ...
                        button("Return to Workbench") {
                            ...
                            setOnAction {
                                workbenchController.returnToWorkbench(this@MetroTileHomepage20)
                            }
