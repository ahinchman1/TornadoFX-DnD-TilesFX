...
class MetroTileHomepage12 : View() {
    private val loginController: LoginController by inject()
    private val workbenchController: WorkbenchController by inject()

    override val root: BorderPane by fxml("/fxml/MetroTileHomepage12.fxml")
    ...
    private val module12Rect: Rectangle by fxid("module12")
    private val module13Rect: Rectangle by fxid("module13")
    private val module14Rect: Rectangle by fxid("module14")
    private val module15Rect: Rectangle by fxid("module15")
    private val module16Rect: Rectangle by fxid("module16")
    private val module17Rect: Rectangle by fxid("module17")
    private val module18Rect: Rectangle by fxid("module18")
    ...
    init {
        with(root) {
            ...
            flowpane {
                ...
                module11Rect.addClass(module_tile)
                module12Rect.addClass(module_tile)
                module13Rect.addClass(module_tile)
                module14Rect.addClass(module_tile)
                module15Rect.addClass(module_tile)
                module16Rect.addClass(module_tile)
                module17Rect.addClass(module_tile)
                module18Rect.addClass(module_tile)
                ...
                vbox {
                    ...
                    hbox {
                        ...
                        button("Return to Workbench") {
                            ...
                            setOnAction {
                                workbenchController.returnToWorkbench(this@MetroTileHomepage12)
                            }
