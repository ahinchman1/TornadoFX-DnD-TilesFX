...
import com.example.demo.app.Styles.Companion.metro_field
...
class MetroTileHomepage8 : View() {
    private val loginController: LoginController by inject()
    private val workbenchController: WorkbenchController by inject()

    override val root: BorderPane by fxml("/fxml/MetroTileHomepage8.fxml")
                ...
                vbox {
                    ...
                    hbox {
                        ...
                        button("Return to Workbench") {
                            ...
                            setOnAction {
                                workbenchController.returnToWorkbench(this@MetroTileHomepage8)
                            }
