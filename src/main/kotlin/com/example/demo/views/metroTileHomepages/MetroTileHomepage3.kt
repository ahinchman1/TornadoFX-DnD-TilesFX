...
class MetroTileHomepage3 : View() {
    private val loginController: LoginController by inject()
    private val workbenchController: WorkbenchController by inject()

    override val root: BorderPane by fxml("/fxml/MetroTileHomepage3.fxml")
                ...
                vbox {
                    ...
                    hbox {
                        ...
                        button("Return to Workbench") {
                            ...
                            setOnAction {
                                workbenchController.returnToWorkbench(this@MetroTileHomepage3)
                            }
